...
class Filter
{
    ...
    /**
     * Filter App\Entities before a specific date.
     *
     * @param string $field The database column name.
     * @param DateTime|string $date The date before which App\Entities should be returned.
     * @param string|null $boolean The boolean operator (AND/OR).
     * @return static
     */
    ...
    /**
     * Filter App\Entities after a specific date.
     * 
     * @param string $field The database column name.
     * @param DateTime|string $date The date after which App\Entities should be returned.
     * @param string|null $boolean The boolean operator (AND/OR).
     * @return static
     */
    ...
    /**
     * Filter App\Entities based on null field.
     * 
     * @param string $field The database column name.
     * @param string|null $boolean The boolean operator (AND/OR).
     * @return static
    ...
    /**
     * Filter App\Entities based on fields with values.
     * 
     * @param string $field The database column name.
     * @param string|null $boolean The boolean operator (AND/OR).
     * @return static
